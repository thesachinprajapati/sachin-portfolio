...
const Hero = () => {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center animated-bg relative bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900">
      ...
      <div className="container-max section-padding text-center relative z-10">
        <div className="animate-fade-in">
          ...
          <h1 className="text-4xl md:text-7xl font-bold mb-6 leading-tight">
            Hi, I'm <span className="gradient-text neon-text relative">
              Sachin Prajapati
          ...
          <p className="text-xl md:text-2xl text-gray-400 mb-8 max-w-3xl mx-auto leading-relaxed">
            ...
            <span className="text-purple-400 font-semibold"> functional</span> digital experiences
          </p>
          ...
          <div className="animate-bounce">
            <a href="#about" className="inline-block text-gray-500 hover:text-blue-400 transition-colors p-2 rounded-full hover:bg-gray-800/50">
              <ArrowDown size={32} />
            </a>
          </div>
        </div>
